...
// one engine option: displacement + its matching power & 0–100
export type EngineVariant = {
  engine: string; // e.g. "2.0L"
  hp: string; // e.g. "197"
  zeroTo100: string; // e.g. "8.1s"
  label?: string; // optional tag e.g. "PLUG-IN", "GR SPORT"
};
...
export type Model = {
  ...
  specs: ModelSpec[];
  variants?: EngineVariant[]; // engine options shown in the lineup
};
...
export const models: Model[] = [
  ...
  { id: "yaris", name: "YARIS", he: "יאריס", cat: "HYBRID HATCH", catHe: "האצ׳בק היברידי", color: "#38bdf8", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/2020_Toyota_Yaris_Design_HEV_CVT_1.5_Front.jpg/330px-2020_Toyota_Yaris_Design_HEV_CVT_1.5_Front.jpg", specs: [], variants: [{ engine: "1.5L", hp: "130", zeroTo100: "9.2s", label: "HYBRID" }] },
  { id: "corolla", name: "COROLLA", he: "קורולה", cat: "THE ICON", catHe: "האייקון", color: "#d4d4d8", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/2018_Toyota_Corolla_%28MZEA12R%29_Ascent_Sport_hatchback_%282018-11-02%29_01.jpg/330px-2018_Toyota_Corolla_%28MZEA12R%29_Ascent_Sport_hatchback_%282018-11-02%29_01.jpg", specs: [], variants: [{ engine: "1.8L", hp: "140", zeroTo100: "9.3s", label: "HYBRID" }] },
  ...
  { id: "yariscross", name: "YARIS CROSS", he: "יאריס קרוס", cat: "COMPACT SUV", catHe: "קרוסאובר קומפקטי", color: "#34d399", badge: "NEW", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/Toyota_Yaris_Cross_Hybrid_%28XP210%29_1X7A1846.jpg/330px-Toyota_Yaris_Cross_Hybrid_%28XP210%29_1X7A1846.jpg", specs: [], variants: [{ engine: "1.5L", hp: "130", zeroTo100: "10.7s", label: "HYBRID" }] },
  { id: "chr", name: "C-HR", he: "C-HR", cat: "COUPE CROSSOVER", catHe: "קרוסאובר קופה", color: "#f472b6", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Toyota_C-HR_Hybrid_%28AX20%29_DSC_7239.jpg/330px-Toyota_C-HR_Hybrid_%28AX20%29_DSC_7239.jpg", specs: [], variants: [{ engine: "1.8L", hp: "140", zeroTo100: "9.9s", label: "HYBRID 140" }, { engine: "2.0L", hp: "197", zeroTo100: "8.1s", label: "GR SPORT" }] },
  ...
  { id: "rav4", name: "RAV4", he: "ראב4", cat: "NEW · GEN 8", catHe: "דור 8", color: "#f59e0b", badge: "NEW", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Toyota_RAV4_XLE_%28facelift%29_%28front%29.jpg/330px-Toyota_RAV4_XLE_%28facelift%29_%28front%29.jpg", specs: [], variants: [{ engine: "2.5L", hp: "236", zeroTo100: "7.8s", label: "HYBRID AWD" }, { engine: "2.5L", hp: "324", zeroTo100: "~6.0s", label: "PLUG-IN" }] },
